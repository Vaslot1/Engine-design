    ...
    def checkTable1(self):
        ...
        for i in range(1, 19 + 1):
            ...
            if (table_1.calculateTable(i, aboba.s_nom) * 0.01 < curr_value < table_1.calculateTable(i,
                ...
                self.ui.tableWidget.item(i, 8).setBackground(QColor(255, 50, 35))
    ...
    def calculate_table2(self):
        for i in range(2, 7):
            for j in range(1, 14 + 1):
                ...
                self.ui.tableWidget_2.item(j, i).setFlags(self.ui.tableWidget_2.item(j, i).flags() & ~Qt.ItemIsEditable)
    ...
    def calculate_table3(self):
        ...
        for i in range(2, 7):
            for j in range(1, 20 + 1):
                ...
                self.ui.tableWidget_3.item(j, i).setFlags(self.ui.tableWidget_3.item(j, i).flags() & ~Qt.ItemIsEditable)

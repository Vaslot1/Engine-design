...
def findTheNumberOfRotorSlots(P_2, Z_1):
    arr = {
        12: [9],
        18: [10, 14],
        24: [15, 16, 17],
...
def kpd_func_b(_2p, P_2):
    x_temp = {
        2: [
            [25],
            [25, 42.47706543, 51.04432759, 75.73396386, 101.4960419, 127.0057492, 151.8090323, 174.9534988, 201.1029363,
             226.2893106, 250.2010264, 275.004843, 300.4190444, 325.2570084, 350]
        ],
    ...
    y_temp = {
        2: [
            [89],
            [89, 90.29402213, 90.75621638, 91.33390845, 91.65, 91.8, 91.88, 91.95, 92.1, 92.22165838, 92.37978281,
             92.52, 92.6590886, 92.84197706, 93]
        ],
...
def kpd_func(_2p, P_2):
    x_temp = {
        ...
        4: [0.06, 0.09, 0.12, 0.18, 0.25, 0.37, 0.56, 0.75, 1.1, 1.5, 2.2, 3, 4, 5.5, 7.5, 11, 15, 18.5, 22, 30, 37, 45,
            55, 75, 90, 110, 132, 160,
            200, 250, 315],
        6: [0, 0.04395066, 0.170162828, 0.243822198, 0.439392666, 0.594943253, 0.722351745, 1.085692394, 1.201564906,
            1.415991717, 1.795625158, 2.049388237, 2.296001857, 2.812443477, 2.945149975, 3.059683743, 3.272088198,
            3.728428785, 4.005577148, 4.52948155, 4.796290257, 5.148351281, 5.340560649, 5.650493982, 6.23532545,
            7.049395358, 7.686010559, 8.074958235, 8.649421563, 9.09100749, 9.389803618, 9.855771764, 11.28503698,
            11.7439696, 12.62150164, 12.99748914, 13.43249529, 14.01541834, 14.36915991, 15.33504901, 16.24650538,
            16.51676064, 17.40141366, 17.88911502, 19.20509976, 19.76888162, 20],
        8: 0,
        10: 0,
        12: 0,
    }[_2p]
    ...
    y_temp = {
        ...
        4: [0.5, 0.55, 0.63, 0.64, 0.68, 0.68, 0.705, 0.72, 0.75, 0.77, 0.8, 0.82, 0.84, 0.855, 0.875, 0.875, 0.885,
            0.895, 0.9, 0.905,
            0.91, 0.92, 0.92, 0.93, 0.93, 0.925, 0.93, 0.935, 0.94, 0.945, 0.945],
        6: [0.625, 0.6436027134, 0.6715196026, 0.6832010469, 0.7079505395, 0.7237041983, 0.7345502617, 0.7620366414,
            0.7698563188, 0.7814875547, 0.8001725243, 0.8101746608, 0.8188820639, 0.8340481786, 0.8375136203,
            0.8400443329, 0.8440342912, 0.8517407328, 0.8550299113, 0.8591993377, 0.8608444611, 0.8625120179,
            0.8631700673, 0.8634894776, 0.8647222519, 0.8674420468, 0.8696106185, 0.8710356799, 0.8731316099,
            0.8745075312, 0.8757413738, 0.8775104156, 0.882271659, 0.8845833778, 0.8876952249, 0.8897772674,
            0.8916745006, 0.8930803333, 0.8944017733, 0.8974484564, 0.9003007157, 0.9014042303, 0.9038772567,
            0.9061579959, 0.9108839868, 0.9136817648, 0.915],
        8: 0,
        10: 0,
        12: 0,
    }[_2p]
...
def cosPhi_func(_2p, P_2):
    x_meow = {
        2: [0.74, 0.973388, 1.116893, 1.223832, 1.446982, 1.89146, 2.331441, 2.959136, 3.552363, 4.126217, 5.586764,
            6.431345, 7.303689, 8.119955, 8.965419, 9.893012, 11.47248, 12.42739, 13.32689, 13.7847, 14.14401, 14.8229,
            15.50195, 16.42955, 17.41255, 18.36697, 19.0458, 19.47648, 20],
        4:
            [0.06, 0.09, 0.12, 0.18, 0.25, 0.37, 0.56, 0.75, 1.1, 1.5, 2.2, 3, 4, 5.5, 7.5, 11, 15, 18.5, 22, 30, 37,
             45, 55, 75, 90, 110, 132,
             160, 200, 250, 315],
        6: [0.8, 0.842914, 0.929683, 1.080865, 1.223359, 1.528406, 1.80169, 1.921744, 2.08961, 2.327533, 2.472517,
            2.838215, 3.212157, 3.507161, 4.305596, 4.866662, 5.409051, 6.266145, 6.653396, 7.189864, 7.966663,
            9.359865, 10.52972, 11.27695, 11.68575, 12.69751, 13.14848, 13.37304, 13.79964, 16.55718, 17.94195,
            18.51209, 19.0272, 20],
        8: 0,
        10: 0,
        12: 0,
    ...
    y_meow = {
        2: [0.848, 0.860277, 0.86652, 0.87042, 0.877063, 0.887114, 0.89427, 0.902129, 0.907382, 0.911606, 0.915458,
            0.916904, 0.918328, 0.919862, 0.921196, 0.92262, 0.925413, 0.926873, 0.928357, 0.929819, 0.93018, 0.931228,
            0.93265, 0.934073, 0.935473, 0.936997, 0.93845, 0.939851, 0.94],
        4:
        ...
        6: [0.675, 0.682935, 0.693397, 0.707135, 0.717776, 0.736578, 0.750502, 0.756113, 0.763139, 0.772087, 0.776672,
            0.786529, 0.795613, 0.801709, 0.815117, 0.822219, 0.828474, 0.836364, 0.838988, 0.843197, 0.848225,
            0.855153, 0.859655, 0.862261, 0.862858, 0.864481, 0.865844, 0.866437, 0.867073, 0.873226, 0.875738,
            0.877159, 0.877786, 0.88],
        8: 0,
        10: 0,
        12: 0,
    }[_2p]
...
def cosPhi_func_b(_2p, P_2):
    x_meow = {
        2: [19.5, 24.5, 31.38635662, 37.87063157, 44.13453082, 66.58243758, 78.60652017, 171.9871229, 255.8344755, 309.9385784, 337.3782884, 350],
        4:
            [0.06, 0.09, 0.12, 0.18, 0.25, 0.37, 0.56, 0.75, 1.1, 1.5, 2.2, 3, 4, 5.5, 7.5, 11, 15, 18.5, 22, 30, 37,
             45, 55, 75, 90, 110, 132,
             160, 200, 250, 315],
...
def A__up(_2p, D_a):
    x_temp = {
        2: [
            ...
            [0.095, 0.103077256, 0.112451388, 0.121148777, 0.131452947, 0.140585108, 0.152471797, 0.160347841,
             ...
             0.26],
            # б)
            [0.27, 0.281776372, 0.292254085, 0.301154414, 0.312008768, 0.32193425, 0.332421755, 0.341704598,
            ...
            # в)
            [0.5, 0.513023191, 0.524780272, 0.535959643, 0.547588755, 0.561078559, 0.572505226, 0.585327205,
        ...
        4: [
            ...
            [0.08, 0.097190855, 0.101793572, 0.1079556, 0.114117296, 0.120873095, 0.130078529, 0.140318423,
             ...
             0.243011928, 0.26],
            # б)
            [0.27, 0.275904081, 0.280521776, 0.290551871, 0.299687882, 0.310313925, 0.32035575, 0.330584602,
            ...
            # в)
            [0.5, 0.512243148, 0.524327085, 0.536951513, 0.547628187, 0.560225736, 0.572374597, 0.584657445,
    ...
    y_temp = {
        2: [
            ...
            # б)
            [36.5, 37.1213195, 37.6730654, 38.0979926, 38.5743272, 38.997606, 39.435033, 39.8049813, 40.1278147,
            ...
            # в)
            [49, 49.27539561, 49.50288048, 49.72165099, 49.91755998, 50.14821702, 50.33628674, 50.50404725, 50.65747831,
        ...
        4: [
            ...
            [17.5, 18.49535144, 19.11137152, 19.8758645, 20.59580236, 21.30089956, 22.24533559, 23.17456657,
             ...
             28.51492005, 29.1],
            # б)
            [33.5, 33.8150861, 34.0371748, 34.5278171, 34.951321, 35.4109529, 35.8331689, 36.2308477, 36.5911107,
            ...
            # в)
            [44, 44.29980059, 44.58168878, 44.85157808, 45.06150725, 45.28866121, 45.49951867, 45.65450732, 45.80746751,
...
def A__down(_2p, D_a):
    x_temp = {
        2: [
            ...
            # б)
            [0.27, 0.275687648, 0.281793342, 0.292253632, 0.300911301, 0.312233118, 0.321939816, 0.333389786,
            ...
            # в)
            [0.5, 0.523461789, 0.535522724, 0.54721102, 0.559456826, 0.572098433, 0.584183356, 0.596835715, 0.610010432,
        ...
        4: [
            ...
            # б)
            [0.27, 0.279946384, 0.289162773, 0.299031987, 0.30997764, 0.320238615, 0.329837242, 0.340019076,
            ...
            # в)
            [0.5, 0.524156092, 0.53740773, 0.547275442, 0.55993116, 0.572140665, 0.584728788, 0.596937878, 0.611082773,
    ...
    y_temp = {
        2: [
            ...
            # б)
            [35.25, 35.5596541, 35.8901174, 36.4577459, 36.8825526, 37.418265, 37.8596667, 38.3072753, 38.6059858,
            ...
            # в)
            [48, 48.51079411, 48.73923362, 48.93725949, 49.12709188, 49.31739632, 49.4795125, 49.64371921, 49.82030042,
        ...
        4: [
            ...
            # б)
            [32.5, 32.9774737, 33.3981134, 33.8178761, 34.2716381, 34.6604034, 35.0190821, 35.4002921, 35.7840655,
            ...
            # в)
            [43.25, 43.84573306, 44.13075539, 44.32551832, 44.55055437, 44.74020761, 44.91155698, 45.05546806,
...
def t_z1__2_max(tau):
    x_meow = [0.039, 0.043231664, 0.047339219, 0.05016655, 0.05357881, 0.056898766, 0.060653155, 0.064054379,
              ...
              0.33373934, 0.337400421, 0.340964182, 0.345316545, 0.349494331, 0.354803853, 0.36]
    y_meow = [0.01, 0.010198106, 0.010429037, 0.010576698, 0.010754878, 0.010928548, 0.011124557, 0.011287949,
              ...
              0.018713609, 0.018727452, 0.018740981, 0.018741505, 0.018742135, 0.018743183, 0.01875]
    if (tau < x_meow[0]):
        return None
...
def t_z1__2_min(tau):
    x_meow = [0.039, 0.040851783, 0.042009682, 0.045553499, 0.049336157, 0.051679006, 0.07027052, 0.072623336,
              ...
              0.347300847, 0.349093045, 0.350848936, 0.355004627, 0.356400655, 0.358175767, 0.36]
    y_meow = [0.0078, 0.007848937, 0.007909175, 0.008074055, 0.00826547, 0.008379846, 0.009248681, 0.00936079,
              ...
              0.015772731, 0.015770098, 0.015775631, 0.015802167, 0.015808634, 0.015809867, 0.0158]
    if (tau < x_meow[0]):
        return None
    return LinearInterpolation(tau, x_meow, y_meow)
